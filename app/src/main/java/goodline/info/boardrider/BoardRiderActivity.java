...
public class BoardRiderActivity extends AppCompatActivity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if(intent.getAction()==SplashScreenActivity.SPLASH_HAS_NEWS || intent.getAction()== NotificationService.NOTI_HAS_NEWS){
